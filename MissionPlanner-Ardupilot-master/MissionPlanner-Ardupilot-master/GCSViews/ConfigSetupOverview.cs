...
namespace MissionPlanner.GCSViews
{
    public class ConfigSetupOverview : MyUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ForeColor = Theme.White;

            // Title
            lblTitle = new Label();
            lblTitle.Text = "Setup & Calibration";
            StyleHelper.ApplyLabelStyle(lblTitle, Theme.HeaderFont, Theme.White);
            ...
            StyleHelper.ApplyLabelStyle(lblSubtitle, Theme.SubtitleFont, Theme.GreyText);
            ...
            StyleHelper.ApplyLabelStyle(lblStatusText, Theme.TechnicalFont, Theme.AccentOrange);
        ...
        private class CardPanel : Panel
        {
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                using (var textBrush = new SolidBrush(Theme.White))
                ...
                Color accentColor = isRequired ? Theme.AccentOrange : Theme.Green;
                ...
                Color pillFg = isRequired ? Theme.AccentOrange : Color.FromArgb(170, 175, 180);
                ...
                using (var pillBorderPen = new Pen(isRequired ? Theme.AccentOrange : Color.Transparent, 1))
                {
                ...
                using (var metaRightBrush = new SolidBrush(title == "Power" ? Color.FromArgb(120, 125, 130) : (isRequired ? Theme.AccentOrange : Color.FromArgb(0, 180, 255))))
                {
            ...
            {
                base.OnMouseEnter(e);
                this.BackColor = Theme.PanelHover;
            }
