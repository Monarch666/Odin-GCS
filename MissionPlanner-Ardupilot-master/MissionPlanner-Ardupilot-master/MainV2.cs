...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        private void SetupSidebarLayout()
        {
            ...
            sidebar.BackColor = OdinTheme.Background;
            sidebar.Padding = new Padding(15);

            // 3. Add to main form and send to back so docking splits nicely with MyView
            this.Controls.Add(sidebar);
            sidebar.SendToBack();

            // 4. Logo Panel at the top
            ...
            try
            {
                logoBox.Image = Image.FromFile(@"C:\Users\ADARSHASINHA\.gemini\antigravity-ide\brain\fee89a26-d6f5-4692-8d20-07c18fe4c409\warrior_logo_1782967240723.png");
            }
            catch {}
            ...
            headerSpacer.Height = 15;
            headerSpacer.Dock = DockStyle.Top;
            sidebar.Controls.Add(headerSpacer);

            // 5. Connection Card at the bottom
            ...
            // Reparent existing connection dropdowns safely
            ...
            baudRateCombo.Dock = DockStyle.Fill;
            ...
            sysIdCombo.Dock = DockStyle.Fill;
            ...
            customConnectBtn.Click += (s, ev) =>
            {
                // Trigger the click of original MenuConnect
            ...
            // Spacer above connection card
            Panel connSpacer = new Panel();
            connSpacer.Height = 15;
            connSpacer.Dock = DockStyle.Bottom;
            sidebar.Controls.Add(connSpacer);

            // 6. Bottom Toolbar below connection card
            ...
            Panel toolSpacer = new Panel();
            toolSpacer.Height = 15;
            toolSpacer.Dock = DockStyle.Bottom;
